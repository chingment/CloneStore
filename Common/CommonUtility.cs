...
namespace Lumos.Common
{
    ...
    public static class CommonUtility
    {
        ...
        public static bool IsDateTime(object strDate)
        {
            ...
            {
                return CommonUtility.IsDateTime(strDate.ToString());
            }
        }
        #endregion
        ...
        {
            if (CommonUtility.IsDateTime(strDate))
            {
        ...
        public static string GetScriptNameUrl
        {
            get
            {
                string Script_Name = CommonUtility.GetScriptName;
        ...
        public static string GetScriptUrl
        {
            get
            {
                return CommonUtility.GetScriptNameQueryString == "" ? CommonUtility.GetScriptName : string.Format("{0}?{1}", CommonUtility.GetScriptName, CommonUtility.GetScriptNameQueryString);
            }
        }
