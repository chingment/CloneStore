...
(function ($) {
    $.lumos.common = {
        ...
        loadingShow: function (msg) {
            ...
            uri = "/Content/Manager/base/images/loading.gif";
            if ($('#lumos_loading').length == 0) {
                $("body").append("<div id='lumos_loading'   > <div class='lumos_loading_indicator' ><img src='" + uri + "' alt='' />System<br /><span id='lumos_loading_msg'>Loading......</span></div></div>");
